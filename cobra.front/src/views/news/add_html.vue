        ...
        <Row class-name="p-content">
            <Form ref="addNewsForm" :rules="rules" :model="form" :label-width="100" class="m-t-20 m-b-100">
                ...
                <FormItem prop="typeId" label="分类">
                    <Poptip placement="bottom-start" width="300" trigger="click">
                ...
                <FormItem prop="content">
                    <tinymce ref="ty" :value="form.content" @onchange="onchange" height="500px" minHeight="500px"></tinymce>
                </FormItem>
