...
<template>
    <Row>
        <Drawer width="500" v-model="isShow" :mask-closable="false" :closable="true">
            <Row class-name="fbold" slot="header">编辑菜单</Row>
            <Row>
                <Alert show-icon>
                ...
                <Form ref="editMenuForm" :rules="rules" :model="form" :label-width="100">
                    ...
                    <FormItem v-if="currentNode">
                        ...
                        <Input :value="currentNode.name" disabled placeholder="上级菜单">
                    ...
                    <FormItem prop="icon" v-show="form.type==1 || form.type==2">
                        ...
                        <a href="javascript:;" @click="selIcon">
    ...
    export default {
        ...
        methods:{
            ...
            save(){
                ...
                this.$refs.editMenuForm.validate((valid) => {
                    if (valid) {
                        ...
                        this.$http('menu_edit',this.form, true).then(res => {
                            this.loading = false
            ...
            selectIcon(icon){
                ...
                //验证图标单独一项
                this.$refs.editMenuForm.validateField("icon")
            },
        }
    }
</script>
