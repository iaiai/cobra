...
<template>
    <Drawer width="60" v-model="isShow" :mask-closable="false" :closable="true">
        <Row class-name="fbold" slot="header">选择图标</Row>
        <Tabs value="icon1">
            <TabPane label="图标1" name="icon1">
                <Row v-for="icon in icons1" class="icon-item pr" @click.native="selIcon(`iconfont iaiai-${icon}`)" :key="icon">
                    <div class="pa icon-i center-txt">
                        <i :class="['i','iconfont',`iaiai-${icon}`]" />
                    </div>
                    <div class="pa f12 icon-txt center-txt">{{icon}}</div>
                </Row>
            </TabPane>
            <TabPane label="图标2" name="icon2">
                <Row v-for="icon in icons2" class="icon-item pr" @click.native="selIcon(`ivu-icon ivu-icon-${icon}`)" :key="icon">
                    <div class="pa icon-i center-txt">
                        <Icon :type="icon" class="i" />
                    </div>
                    <div class="pa f12 icon-txt center-txt">{{icon}}</div>
                </Row>
            </TabPane>
